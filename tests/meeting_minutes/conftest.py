...
def valid_draft_dict_1page() -> dict:
    return {
        ...
        "summary_items": [
            {
                "text": "2026년 스마트팜 보급 확대 추진 계획 논의",
                "subs": [
                    {"text": "총 예산 50억 원 규모로 전국 20개 시군 대상 시범"},
                    {
                        "text": "4월 말 공모 공고 후 5월 중 대상지 선정 예정",
                        "detail": "5월 15일까지 신청서 제출, 6월 초 현장 조사 실시",
                    },
                ],
            },
            {
                ...
                "subs": [
                    {"text": "온라인 교육 비중을 기존 30%에서 50%로 상향"},
                ],
            },
            {
                "text": "병해충 예찰 강화를 위한 드론 활용 방안 합의",
                "subs": [],
            },
            {
                "text": "농산물 수출 확대를 위한 해외 시장 조사 추진",
                "subs": [
                    {"text": "동남아 3개국 대상 현지 수요 조사 실시 결정"},
                ],
            },
        ],
        "detail_items": [
            {
                "text": "스마트팜 보급 사업 세부 추진 일정 확정",
                "subs": [
                    {"text": "4월 25일 공모 공고, 5월 15일 신청 마감"},
                    {
                        "text": "선정 기준: 농지 면적 1ha 이상, 청년 농업인 우선",
                        "detail": "청년 농업인(만 39세 이하) 가점 10점 부여",
                    },
                ],
            },
            {
                "text": "교육 프로그램 개편 세부 계획 수립 지시",
                "subs": [
                    {"text": "6월 말까지 개편안 마련, 7월 시범 운영 시작"},
                ],
            },
            {
                "text": "드론 예찰 시범 사업 대상지 3곳 선정 완료",
                "subs": [],
            },
        ],
        "next_steps": [
